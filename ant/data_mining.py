...
train_path = "data/train_int32.csv"  #train.csv
#unlabel_path = "data/unlabel.csv"
validation_path = "data/validation_int32.csv" #validation.csv
...
seg_date = 20180215
params =  { "max_depth" : [3, 4], "min_child_weight" : [1, 2], } # params = None "subsample" : [0.7, 0.8]
