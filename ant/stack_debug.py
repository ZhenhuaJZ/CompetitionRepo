...
def two_layer_stacking(train_data, test):
    ...
    classifier = [
            ...
            RandomForestClassifier(n_estimators = 1, min_samples_split = 110, max_depth = 25, criterion='entropy', n_jobs = -1), #160
            LogisticRegression(class_weight = "balanced", C = 2),
            ExtraTreesClassifier(n_estimators = 1, n_jobs = -1, min_samples_split = 70),
            GradientBoostingClassifier(n_estimators = 1, learning_rate = 0.08),
    ]
    print(classifier)
