...
def core(offline_validation, method, params_path, score_path, clf, _train, _labels, _test_offline_feature, _test_offline_labels, _test_online):
    start = time.time()
...
def main():
	...
	if tunning:
		for p in range(1,40,5):
			...
			core(offline_validation, params_path, score_path, clf, _train, _labels, _test_offline_feature, _test_offline_labels, _test_online)
	else:
		classifier = {
		...
		_train, _labels, _test_offline_feature, _test_offline_labels, _test_online, _test_a, _train_data = data_edit(params_path, train_path, test_path, test_a_path, offline_validation)
		core(offline_validation, method, params_path, score_path, clf, _train, _labels, _test_offline_feature, _test_offline_labels, _test_online)
