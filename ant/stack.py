...
def two_layer_stacking(train_data, test):
    ...
    classifier = [
            ...
            XGBClassifier(n_estimators=460, max_depth=3, learning_rate = 0.07, #380
                    gamma = 0, n_jobs = -1, subsample = 0.8, colsample_bytree = 0.8),
            RandomForestClassifier(n_estimators = 260, min_samples_split = 110, max_depth = 25, criterion='entropy', n_jobs = -1), #160
            ExtraTreesClassifier(n_estimators = 340, n_jobs = -1, min_samples_split = 70),
...
def read_saved_layer(train_data, test, label):
    ...
    layer2_classifier = [
        XGBClassifier(n_estimators=460, max_depth=4, learning_rate = 0.07,
                          gamma = 0.1, n_jobs = -1,
                          subsample = 0.8, colsample_bytree = 0.8),

        RandomForestClassifier(n_estimators = 350, min_samples_split = 100, max_depth = 20, criterion='entropy', n_jobs = -1),
    ]
    print(layer2_classifier)
